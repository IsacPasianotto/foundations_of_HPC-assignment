 ...
 * modifiedby: Isac Pasianotto for DSSC final project in foundations of HPC
 * 
 * note by Isac Pasianotto: my modifications with respect to the code given by 
 * my professor (stefano Cozzini) consist only in changing the way the
 * program prints the results. The output this code will give is more
 * suitable for the creation of a table in a format such as csv.
 * No changes have been made to the code about how the benchmark is performed.
 */
